...
def apply_pmet_to_model(
    ...
    **kwargs
    ...
    deltas, keys = execute_pmet(model, tok, requests, hparams, cache_template=cache_template) #存储了Equ14 左右的值
...
def execute_pmet(
    ...
    return deltas, torch.vstack(layer_kss) # [N, D]
